...
//-------------------------------------------------------
	...
	, midiImportSpeed(conf, "MIDI Settings", "MidiImportSpeed", LoadSaveSettingsDefaults().LoadMIDISpeed())
	, midiImportPatternLen(conf, "MIDI Settings", "MidiImportPatLen", LoadSaveSettingsDefaults().LoadMIDIPatternLength())
	// Pattern Editor
	...
	, m_FLACCompressionLevel(conf, "Sample Editor", "FLACCompressionLevel", LoadSaveSettingsDefaults().SaveFLACCompressionLevel())
