...
//------------------------------------------------------------------------------------
{
	...
	// * 1x InterpolationMaxLookahead samples before the actual sample start. This is currently hardcoded to 16 samples because of FreeSample!
	// * 1x InterpolationMaxLookahead samples of silence after the sample end.
	...
	// * 4x InterpolationMaxLookahead for the sustain loop (see the two points above)
