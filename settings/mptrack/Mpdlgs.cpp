...
//------------------------------------
{
	...
	if(TrackerSettings::Instance().MixerFlags & SNDMIX_SOFTPANNING) CheckDlgButton(IDC_CHECK2, MF_CHECKED);
...
//----------------------------------------------------------
{
...

	{
		...
		if(TrackerSettings::Instance().GetSoundDeviceID() == dev)
		{
...
//-------------------------
{
	...
	if (s != "")
		TrackerSettings::Instance().ResamplerCutoffPercent = atoi(s);
